...
class SougouNBC():
    def __init__(self, save_file_name='./data/sougou/result/sougou_result_nbc_no_seg.csv'):
        ...
        self.train_file_name = './data/2W.TRAIN.pro.no.seg.jieba'  # 2W.TRAIN.PRO.NO.SEG.jieba
        self.gender_train = './data/2W.TRAIN.pro.no.seg.jieba'
        self.female_train = './data/2W.TRAIN.pro.no.seg.female.jieba'
        self.male_train = './data/2W.TRAIN.pro.no.seg.male.jieba'
